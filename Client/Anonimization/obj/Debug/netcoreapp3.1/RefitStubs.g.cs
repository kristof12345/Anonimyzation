...
namespace Anonimization.Services
{
    ...
    partial class AutoGeneratedIAnonimizationApi : IAnonimizationApi
    {
        ...
        /// <inheritdoc />
        Task<Dataset> IAnonimizationApi.GetDatasetByName(string name)
        {
            var arguments = new object[] { name };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetDatasetByName", new Type[] { typeof(string) });
            return (Task<Dataset>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<EqulivalenceClass> IAnonimizationApi.GetEqulivalenceClassById(int id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetEqulivalenceClassById", new Type[] { typeof(int) });
        ...
        /// <inheritdoc />
        Task<UploadSessionResponse> IAnonimizationApi.StartUploadSession(UploadSessionRequest request)
        {
            var arguments = new object[] { request };
            var func = requestBuilder.BuildRestResultFuncForMethod("StartUploadSession", new Type[] { typeof(UploadSessionRequest) });
            return (Task<UploadSessionResponse>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<UploadResponse> IAnonimizationApi.UploadDocument(string sessionId, int classId, Document document)
        {
            var arguments = new object[] { sessionId, classId, document };
            var func = requestBuilder.BuildRestResultFuncForMethod("UploadDocument", new Type[] { typeof(string), typeof(int), typeof(Document) });
            return (Task<UploadResponse>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<AnonimizationResults> IAnonimizationApi.GetDocuments(string dataset)
        {
            var arguments = new object[] { dataset };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetDocuments", new Type[] { typeof(string) });
            return (Task<AnonimizationResults>)func(Client, arguments);
        }
    }
}
